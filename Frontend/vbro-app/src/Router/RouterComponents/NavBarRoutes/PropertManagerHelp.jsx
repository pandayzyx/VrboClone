...
export default function PropertManagerHelp() {
    return (
        <div>
            <div className={styles.grid1}>
                <div className={styles.ho}>
                    ...
                    <div className={styles.leftmenu}> <a className={styles.leftmenu1} href="https://help.vrbo.com/category/Software_Integration">Software Integration</a></div>
                    ...
                    <div className={styles.grid2}>
                        <div className='text-muted'>
                            <div className={styles.grid3} style={{marginTop: '30px', marginLeft: '80px'}}>
                                ...
                                <div style={{textAlign: 'justify'}}>What do travellers want from a booking<br /> experince?</div>
                            </div>
                                <hr />
                            <div className={styles.grid3} style={{marginLeft: '80px'}}>
                                <img src="https://via.placeholder.com/150" className='rounded-circle' style={{marginRight: '10px'}} width='50px' alt=""/>
                                <div style={{textAlign: 'justify'}}>What can I do if my reservation is affected by<br /> the coranavirus (COVID-19)?</div>
                            </div>
                        </div>
                        <div>
