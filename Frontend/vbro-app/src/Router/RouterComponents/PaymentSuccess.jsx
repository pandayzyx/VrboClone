      ...
      <div>
        <div className="container d-flex mt-5">
          <div className="col-7 d-flex">
            ...
            >
              <div>
                <span style={{ fontWeight: "bolder" }}>{firstname}</span>, your
            ...
            <div className="card mt-3">
              <div className="d-flex">
                ...
                <div className="col-4 p-3">
                  <img
                    src="https://remap.travelerwp.com/wp-content/uploads/2015/01/2019-03-25-21-02-41-721563-Jessica_Nash_PhotographyOne_Fine_Stay-scaled-110x110.jpg"
                    alt="img"
                  />
                </div>
              </div>
              ...
              <div className="d-flex p-2 text-justify my-3">
                <div className="col-9" style={{ fontWeight: "bolder" }}>
                  Paid Amount
                </div>
