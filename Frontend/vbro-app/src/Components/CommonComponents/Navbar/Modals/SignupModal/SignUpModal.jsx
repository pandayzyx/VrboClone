...
class SignUPModal extends React.Component {
  ...
  checkValidEmail = () => {
    let { isAlreadyRegistered } = this.props;
    ...
    if (
      ...
      sendRegisterData({
        ...
        callback: () => {
          console.log(this.props.isAlreadyRegistered);
          if (this.props.isAlreadyRegistered) {
            this.setState({
              isMailAlreadyPresnt: true,
              isDefaultComponent: false,
            });
          } else if (this.props.isAlreadyRegistered === false) {
            this.setState({
              isMailAlreadyPresnt: false,
              isDefaultComponent: false,
              isValidMailNew: true,
...
const MapStateToProps = (state) => {
  return {
    ...
    isAlreadyRegistered: state.register.isAlreadyRegistered,
