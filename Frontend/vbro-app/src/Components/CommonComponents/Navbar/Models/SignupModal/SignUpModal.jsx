					...
					<div class="modal-dialog mt-5">
						<div class="modal-content">
							<div class="modal-header bg bg-primary">
								<h3 style = {{marginTop:"30px"}} class="modal-title text-white" id="exampleModalLabel">
							...
							<div class="modal-body col-10 offset-1 pb-4 shadow-lg">
								<div className="row card">
									...
									<div className="col-6 offset-2 mt-5">
										<button style = {{borderRadius:"20px"}} class = "btn btn-primary btn-block disabled ml-4">
											Get started
										</button>
										<br></br>
                                        <br></br>
